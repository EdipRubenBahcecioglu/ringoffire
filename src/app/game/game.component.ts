...
export class GameComponent implements OnInit {
  ...
  takeCard() {
    if(!this.game.pickCardAnimation){ // Alle 1,5 Sekunden können wir eine neue Karte ziehen, da im Timeout die bolean Variable erst wieder auf false gesetzt wird
